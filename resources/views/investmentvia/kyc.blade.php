        ...
        {!! Form::model($kyc, ['route' => ['kycForm'],'class'=>'form-inline findus','id'=>'contact-form','files'=>true]) !!}
          ...
          <div class="row">
            ...
            <p>Full Name (required)</p>
             ...
             <div class="col-md-4 col-sm-4">
            <p>Father/Spouse Name (required)</p>
              <div class="form-group">
...
" name="father_spouse" id="father_spouse" required="" value="{{ old('name') }}" >
            ...
            <p>Pin Code</p>
             ...
             <div class="col-md-4 col-sm-4">
            <p>Residential Address (required)
</p>
              <div class="form-group">
                 <input type="text" class="form-control" value="{{ old('Address') }}"  placeholder="Address" name="Address" id="Address" required="required">

              </div>
            </div>
             
             <div class="col-md-4 col-sm-4">
            <p>Home / Mobile Telephone (required)</p>
              <div class="form-group">
